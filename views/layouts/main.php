                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-md-6">
                        <div class="short_contact_list">
                            <ul>
                                <li><a href="#"> <i class="fa fa-envelope"></i> SpaceRent@gmail.com</a></li>
                                <li><a href="tel:3476206226"> <i class="fa fa-phone"></i>050-786-1684</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="main-menu  d-none d-lg-block">
                            <nav>
                                <ul id="navigation">
                                    ...
                                    <li><a href="<?= Url::to('/placement')?>">Placement</a></li>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-4 col-md-6 col-lg-3">
                    <div class="footer_widget">
                        <h3 class="footer_title"align="center" style="color: #4b5d96">
                            Our Vision
                        </h3>
                        <p>
                            We believe in the power of communication, the strength of strategy, and the capability of technology to transform your lives. Contact us today for a free  consultation.
                        </p>
                    </div>
                </div>
            </div>
